			...
			<td style="padding: 30px 0;">
					...
					<tr>
						<th class="column" width="640" style="padding-left: 30px; padding-right: 30px; text-align: left;">
							<a href="<?= base_url(); ?>" style="text-decoration: none;">
								<img class="mobile-center" src="<?= base_url(); ?>assets/images/logo.png" width="250" alt="<? echo SITE_NAME; ?> - Recibo de Pago" style="border: 0; width: 100%; max-width: 250px;">
							</a>
						</th>
					</tr>
					<tr>
							...
							<table class="row" align="center" cellpadding="0" cellspacing="0">
								<tr>
									<th class="column" width="310" style="padding-right: 10px; color: #969AA1; font-size: 13px; font-weight: 400; text-align: left;">
										...
										<div class="sans-serif" style="font-size: 14px;"><strong>Order No</strong>: <? echo $orden->id; ?></div>
									</th>
								</tr>
							</table>
						</th>
							...
							<tr class="mobile-valign-top">
								<th class="column mobile-4" width="145" style="padding-left: 30px; padding-right: 10px; text-align: left;">
									<a href="#" style="display: inline-block; text-decoration: none;">
										<img src="<? echo base_url(); ?>images/favicon.png" width="100" alt="<? echo $item->name; ?>" style="border: 0; width: 100%; max-width: 100px;">
									</a>
								</th>
						...
						<table class="row" align="center" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0">
							<tr class="mobile-valign-top">
								...
								<th style="padding-right: 30px;">
									<? if (!is_null($cuentaftp)) {
										echo 'Usuario ftp: ' . $cuentaftp->userid;
										echo '<br>Contraseña ftp: ' . $cuentaftp->passwd;
										echo '<br>Servidor ftp: 51.222.40.65';
										$homedir = explode('/', $cuentaftp->homedir);
										if ($homedir[3] === "") {
											$access = 'todos nuestros productos';
										} else {
											$access = $homedir[3];
										}
										echo '<br>Con acceso a ' . $access . '. <br>' . $item->gigas . ' gigas disponibles para que descarges.';
									}
									?>
								</th>
								<th><? if ($item->duration > 1) { ?>
										<? echo 'DURANTE ' . $item->duration . ' DIAS'; ?>
									<? } else { ?>
										<? echo 'DURANTE ' . $item->duration . ' DIA'; ?>
									<? } ?></th>
							</tr>
						</table>
					<? }
				...
				if (isset($cupon)) { ?>
					<table class="row" align="center" bgcolor="#ff0000" cellpadding="0" cellspacing="0">
						<tr>
							<th class="column mobile-6" width="310" style="padding-left: 30px; padding-right: 10px; font-weight: 700; color: #ffffff; text-align: left;">
								<div class="sans-serif" style="font-size: 16px;">Descuento</div>
							</th>
							<th class="column mobile-6" width="310" style="padding-left: 10px; font-weight: 700; color: #ffffff; text-align: right; padding-right: 30px;">
								...
								<tr valign="top" style="vertical-align: top;">
									<th class="column mobile-padding-bottom" width="255" style="padding-top: 10px; padding-right: 10px; text-align: left;">
										<a href="<? echo base_url(); ?>">
											<img src="<? echo base_url(); ?>assets/images/logo.png" width="250" alt="<?= SITE_NAME ?>" style="border: 0; width: 100%; max-width: 250px;">
										</a>
									</th>
								</tr>
							</table>
							...
							<table class="row" cellpadding="0" cellspacing="0">
								<tr valign="top" style="vertical-align: top;">
									<th class="column mobile-6" width="200" style="padding-right: 10px; color: #969AA1; font-weight: 400; text-align: left;">
										<div class="sans-serif" style="font-size: 14px; font-weight: 700; margin-bottom: 15px;"><?= SITE_NAME ?></div>
									</th>
							...
							<table class="row" cellpadding="0" cellspacing="0">
								<tr>
									<th class="column" width="640" style="color: #969AA1; font-weight: 400; text-align: left;">
										<div class="sans-serif">&copy; <?= SITE_NAME ?>. Todos los derechos reservados <a href="<? echo base_url(); ?>" style="color: #969AA1; text-decoration: none;">Terminos &amp; Condiciones</a></div>
									</th>
								</tr>
								<tr>
