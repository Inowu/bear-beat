            ...
            <tr>
              <th class="column" width="640" style="padding-left: 30px; padding-right: 30px; text-align: left;">
                <a href="<? echo base_url(); ?>" style="text-decoration: none;">
                  <img class="mobile-center" src="https://videoremixespacks.com/assets/images/logo.png" width="105" alt="VIDEOREMIXESPACKS.COM - Recibo de Pago" style="border: 0; width: 100%; max-width: 105px;">
                </a>
              </th>
            </tr>
            <tr>
                  ...
                  <tr valign="top" style="vertical-align: top;">
                    <th class="column mobile-padding-bottom" width="255" style="padding-top: 10px; padding-right: 10px; text-align: left;">
                      <a href="https://videoremixespacks.com">
                        <img src="https://videoremixespacks.com/images/icon-white.png" width="78" alt="VIDEOREMIXESPACKS.COM" style="border: 0; width: 100%; max-width: 38px;">
                      </a>
                    </th>
                  ...
                  <tr valign="top" style="vertical-align: top;">
                    ...
                    <th class="column mobile-6" width="420" style="padding-left: 10px; font-weight: 400; text-align: left;">
                      <div class="sans-serif" style="line-height: 100%; margin-bottom: 15px;">
                        <a href="https://videoremixespacks.com/faq/" style="color: #969AA1; text-decoration: none;">FAQ</a>
                      </div>
                      <div class="sans-serif" style="line-height: 100%; margin-bottom: 15px;">
