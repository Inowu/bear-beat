          ...
          <table class="row" align="center" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <th class="column" width="640" style="padding-left: 30px; padding-right: 30px; text-align: left;">
                <a href="https://videoremixespacks.com" style="text-decoration: none;">
                  <img class="mobile-center" src="https://videoremixespacks.com/assets/images/logo.png" width="250" alt="VIDEOREMIXESPACKS.COM" style="border: 0; width: 100%; max-width: 250px;">
                </a>
              </th>
            </tr>
            <tr>
                ...
                <table class="row" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <th class="column" width="640" style="text-align: left;">
                      ...
                      <div class="sans-serif" style="color: #969AA1; font-size: 18px; font-weight: 400; line-height: 28px; margin-bottom: 40px;">Haz recibido una nueva solicitud para ser miembro en videoremixespacks.com</div>
                    </th>
                    <? }else{ ?>
                      <th class="column" width="640" style="text-align: left;">
                        <div class="serif" style="color: #1F2225; font-size: 28px; font-weight: 700; line-height: 50px; margin-bottom: 30px;">Hola Administrador,</div>
                        <div class="sans-serif" style="color: #969AA1; font-size: 18px; font-weight: 400; line-height: 28px; margin-bottom: 40px;">Haz recibido un mensaje.</div>
                      </th>
                    <? } ?>
                  </tr>
                </table>
                ...
                <table class="row" cellpadding="0" cellspacing="0">
                  <tr valign="top" style="vertical-align: top;">
                    <th class="column mobile-padding-bottom" width="255" style="padding-top: 10px; padding-right: 10px; text-align: left;">
                      <a href="https://videoremixespacks.com">
                        <img src="https://videoremixespacks.com/assets/images/logo.png" width="250" alt="VIDEOREMIXESPACKS.COM" style="border: 0; width: 100%; max-width: 250px;">
                      </a>
                    </th>
                      ...
                      <table align="right" class="mobile-left" cellpadding="10" cellspacing="0">
                        <tr>
                          <td style="padding-left: 0;">
                            <a href="https://www.facebook.com/VideoRemixesVR/" style="text-decoration: none;">
                              <img src="https://videoremixespacks.com/assets/images/icons/facebook.png" width="24" alt="Twitter" style="border: 0; width: 100%; max-width: 24px;">
                            </a>
                          </td>
                ...
                <table class="row" cellpadding="0" cellspacing="0">
                  <tr valign="top" style="vertical-align: top;">
                    <th class="column mobile-6" width="200" style="padding-right: 10px; color: #969AA1; font-weight: 400; text-align: left;">
                      <div class="sans-serif" style="font-size: 14px; font-weight: 700; margin-bottom: 15px;">VIDEOREMIXESPACKS.COM</div>
                    </th>
                    <th class="column mobile-6" width="420" style="padding-left: 10px; font-weight: 400; text-align: left;">
                      ...
                      <div class="sans-serif" style="line-height: 100%; margin-bottom: 15px;">
                        <a href="https://videoremixespacks.com" style="color: #969AA1; text-decoration: none;">Visitar Sitio Web</a>
                      </div>
                    </th>
                  </tr>
                </table>
                ...
                <table class="row" cellpadding="0" cellspacing="0">
                  <tr>
                    <th class="column" width="640" style="color: #969AA1; font-weight: 400; text-align: left;">
                      <div class="sans-serif">&copy; VIDEOREMIXESPACKS. Todos los derechos reservados <a href="https://videoremixespacks.com" style="color: #969AA1; text-decoration: none;">Terminos &amp; Condiciones</a></div>
                    </th>
                  </tr>
                  <tr>
