    ...
    <table class="wrapper" align="center" bgcolor="#EEEEEE" cellpadding="0" cellspacing="0" width="100%">
      <tr>
        <td style="padding: 30px 0;">
          ...
          <!-- Header Left -->
          <table class="row" align="center" bgcolor="#292929" cellpadding="0" cellspacing="0">
            <tr>
            ...
            <tr>
              <th class="column" width="640" style="padding-left: 30px; padding-right: 30px; text-align: left;">
                <a href="<? echo base_url(); ?>" style="text-decoration: none;">
                  <img class="mobile-center" src="<? echo base_url('/assets/images/osonuevo.png'); ?>" width="105" alt="<? echo SITE_NAME; ?>" style="border: 0; width: 100%; max-width: 105px;">
                </a>
              </th>
            </tr>
            <tr>
          ...
          <!-- Intro Basic -->
          <table class="row" align="center" bgcolor="#313131" cellpadding="0" cellspacing="0">
            <tr>
              <td class="spacer" height="40" style="font-size: 40px; line-height: 40px; mso-line-height-rule: exactly;">&nbsp;</td>
            </tr>
            <tr>
                ...
                <table class="row" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <th class="column" width="640" style="text-align: left;">
                      <div class="serif" style="color: #FFFFFF; font-size: 28px; font-weight: 700; line-height: 50px; margin-bottom: 20px;">Hola!</div>
                      <div class="sans-serif" style="color: #eeeeee; font-size: 18px; font-weight: 400; line-height: 28px; margin-bottom: 20px;">Gracias por registrarte</div>
                    </th>
                  </tr>
                </table>
              </th>
          ...
          <!-- Product Row -->
          <table class="row" align="center" bgcolor="#2C2C2C" cellpadding="0" cellspacing="0">
            <tr>
            ...
            <tr class="mobile-valign-top">
              <td style="padding: 20px; font-size: 16px; color: #FFFFFF ">
                  Bienvenido a nuestra gran comunidad de djs y vdjs, ya puedes acceder a tu cuenta accediendo al sitio web:<br><br>
                  <strong>E-mail:</strong> <? echo $email; ?><br>
                  <?= isset($password)  ? '<strong>Password:</strong> '.$password.'<br>' : '' ?>
                  <div style="height: 20px;"></div>
                  <a href="<? echo base_url(); ?>" style="background: #08e1f7; padding: 10px; color: #000000; font-weight: bold; border-radius: 7px; text-align: center; ">IR A SITIO WEB</a>
              </td>
            </tr>
            <tr>
              <td class="spacer" height="80" style="font-size: 80px; line-height: 80px; mso-line-height-rule: exactly;">&nbsp;</td>
                  ...
                  <tr valign="top" style="vertical-align: top;">
                    <th class="column mobile-padding-bottom" width="255" style="padding-top: 10px; padding-right: 10px; text-align: left;">
                      <a href="<? echo base_url(); ?>">
                        <img src="<? echo base_url('/assets/images/osonuevo.png'); ?>" width="250" alt="<? echo SITE_NAME; ?>" style="border: 0; width: 100%; max-width: 250px;">
                      </a>
                    </th>
                  </tr>
                </table>
                ...
                <table class="row" cellpadding="0" cellspacing="0">
                  <tr valign="top" style="vertical-align: top;">
                    <th class="column mobile-6" width="200" style="padding-right: 10px; color: #969AA1; font-weight: 400; text-align: left;">
                      <div class="sans-serif" style="font-size: 14px; font-weight: 700; margin-bottom: 15px;"><? echo SITE_NAME; ?></div>
                    </th>
                    <th class="column mobile-6" width="420" style="padding-left: 10px; font-weight: 400; text-align: left;">
                      <div class="sans-serif" style="line-height: 100%; margin-bottom: 15px;">
                        <a href="<? echo base_url(); ?>" style="color: #969AA1; text-decoration: none;">Visitar Sitio Web</a>
                      </div>
                    </th>
                  </tr>
                </table>
                ...
                <table class="row" cellpadding="0" cellspacing="0">
                  <tr>
                    <th class="column" width="640" style="color: #969AA1; font-weight: 400; text-align: left;">
                      <div class="sans-serif">&copy; <? echo base_url(); ?>. Todos los derechos reservados <a href="<? echo  base_url(); ?>" style="color: #969AA1; text-decoration: none;">Terminos &amp; Condiciones</a></div>
                    </th>
                  </tr>
                  <tr>
