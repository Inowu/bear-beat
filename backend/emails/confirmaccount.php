            ...
            <tr>
              <th class="column" width="640" style="padding-left: 30px; padding-right: 30px; text-align: left;">
                <a href="<? echo base_url(); ?>" style="text-decoration: none;">
                  <img class="mobile-center" src="<? echo base_url('/assets/images/logo.png'); ?>" width="105" alt="<? echo SITE_NAME; ?>" style="border: 0; width: 100%; max-width: 105px;">
                </a>
              </th>
            </tr>
            <tr>
          ...
          <table class="row" align="center" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0">
            ...
            <tr class="mobile-valign-top">
              <td style="padding: 20px; font-size: 16px; ">
                  Confirma tu correo electrónico para poder ingresar a nuestra plataforma. Para hacerlo haz click en el siguiente enlace:<br><br>
                  <a href="<? echo base_url('confirmaccount/?email=');?><? echo $email; ?>&token=<? echo $token; ?>" style="background: darkred; padding: 10px; color: white; border-radius: 7px; text-align: center; ">CONFIRMAR</a>
              </td>
            </tr>
            <tr>
              <td class="spacer" height="80" style="font-size: 80px; line-height: 80px; mso-line-height-rule: exactly;">&nbsp;</td>
                  ...
                  <tr valign="top" style="vertical-align: top;">
                    <th class="column mobile-padding-bottom" width="255" style="padding-top: 10px; padding-right: 10px; text-align: left;">
                      <a href="<? echo base_url(); ?>">
                        <img src="<? echo base_url('/assets/images/logo.png'); ?>" width="250" alt="<? echo SITE_NAME; ?>" style="border: 0; width: 100%; max-width: 250px;">
                      </a>
                    </th>
                        ...
                        <tr>
                          <td style="padding-left: 0;">
                            <a href="https://www.facebook.com/VideoRemixesVR/" style="text-decoration: none;">
                              <img src="<? echo base_url('assets/images/icons/facebook.png'); ?>" width="24" alt="Twitter" style="border: 0; width: 100%; max-width: 24px;">
                            </a>
                          </td>
                          <td>
                ...
                <table class="row" cellpadding="0" cellspacing="0">
                  <tr valign="top" style="vertical-align: top;">
                    <th class="column mobile-6" width="200" style="padding-right: 10px; color: #969AA1; font-weight: 400; text-align: left;">
                      <div class="sans-serif" style="font-size: 14px; font-weight: 700; margin-bottom: 15px;"><? echo base_url(); ?></div>
                    </th>
