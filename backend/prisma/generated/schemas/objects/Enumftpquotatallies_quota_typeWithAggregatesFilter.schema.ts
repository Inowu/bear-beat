...
import { NestedEnumftpquotatallies_quota_typeWithAggregatesFilterObjectSchema } from './NestedEnumftpquotatallies_quota_typeWithAggregatesFilter.schema';
...
const Schema: z.ZodType<Prisma.Enumftpquotatallies_quota_typeWithAggregatesFilter> =
  z
    .object({
...
export const Enumftpquotatallies_quota_typeWithAggregatesFilterObjectSchema =
  Schema;
