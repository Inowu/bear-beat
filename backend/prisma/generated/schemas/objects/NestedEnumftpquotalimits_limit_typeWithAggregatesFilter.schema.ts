...
const Schema: z.ZodType<Prisma.NestedEnumftpquotalimits_limit_typeWithAggregatesFilter> =
  z
    .object({
...
export const NestedEnumftpquotalimits_limit_typeWithAggregatesFilterObjectSchema =
  Schema;
