...
export const userfilesRouter = router({
  aggregateUserFiles: shieldedProcedure
    .input(UserFilesAggregateSchema)
    .query(async ({ ctx, input }) => {
      const aggregateUserFiles = await ctx.prisma.userFiles.aggregate(input);
      return aggregateUserFiles;
    }),
  createManyUserFiles: shieldedProcedure
    .input(UserFilesCreateManySchema)
    .mutation(async ({ ctx, input }) => {
      const createManyUserFiles = await ctx.prisma.userFiles.createMany(input);
      return createManyUserFiles;
    }),
  createOneUserFiles: shieldedProcedure
    .input(UserFilesCreateOneSchema)
    .mutation(async ({ ctx, input }) => {
      const createOneUserFiles = await ctx.prisma.userFiles.create(input);
      return createOneUserFiles;
    }),
  deleteManyUserFiles: shieldedProcedure
    .input(UserFilesDeleteManySchema)
    .mutation(async ({ ctx, input }) => {
      const deleteManyUserFiles = await ctx.prisma.userFiles.deleteMany(input);
      return deleteManyUserFiles;
    }),
  deleteOneUserFiles: shieldedProcedure
    .input(UserFilesDeleteOneSchema)
    .mutation(async ({ ctx, input }) => {
      const deleteOneUserFiles = await ctx.prisma.userFiles.delete(input);
      return deleteOneUserFiles;
    }),
  findFirstUserFiles: shieldedProcedure
    .input(UserFilesFindFirstSchema)
    .query(async ({ ctx, input }) => {
      const findFirstUserFiles = await ctx.prisma.userFiles.findFirst(input);
      return findFirstUserFiles;
    }),
  findFirstUserFilesOrThrow: shieldedProcedure
    .input(UserFilesFindFirstSchema)
    .query(async ({ ctx, input }) => {
      const findFirstUserFilesOrThrow =
        await ctx.prisma.userFiles.findFirstOrThrow(input);
      return findFirstUserFilesOrThrow;
    }),
  findManyUserFiles: shieldedProcedure
    .input(UserFilesFindManySchema)
    .query(async ({ ctx, input }) => {
      const findManyUserFiles = await ctx.prisma.userFiles.findMany(input);
      return findManyUserFiles;
    }),
  findUniqueUserFiles: shieldedProcedure
    .input(UserFilesFindUniqueSchema)
    .query(async ({ ctx, input }) => {
      const findUniqueUserFiles = await ctx.prisma.userFiles.findUnique(input);
      return findUniqueUserFiles;
    }),
  findUniqueUserFilesOrThrow: shieldedProcedure
    .input(UserFilesFindUniqueSchema)
    .query(async ({ ctx, input }) => {
      const findUniqueUserFilesOrThrow =
        await ctx.prisma.userFiles.findUniqueOrThrow(input);
      return findUniqueUserFilesOrThrow;
    }),
  groupByUserFiles: shieldedProcedure
    .input(UserFilesGroupBySchema)
    .query(async ({ ctx, input }) => {
      const groupByUserFiles = await ctx.prisma.userFiles.groupBy({
        where: input.where,
  ...
  updateManyUserFiles: shieldedProcedure
    .input(UserFilesUpdateManySchema)
    .mutation(async ({ ctx, input }) => {
      const updateManyUserFiles = await ctx.prisma.userFiles.updateMany(input);
      return updateManyUserFiles;
    }),
  updateOneUserFiles: shieldedProcedure
    .input(UserFilesUpdateOneSchema)
    .mutation(async ({ ctx, input }) => {
      const updateOneUserFiles = await ctx.prisma.userFiles.update(input);
      return updateOneUserFiles;
    }),
  upsertOneUserFiles: shieldedProcedure
    .input(UserFilesUpsertSchema)
    .mutation(async ({ ctx, input }) => {
