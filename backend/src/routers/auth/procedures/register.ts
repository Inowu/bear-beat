  ...
  .mutation(
    async ({
      ...
      const baseUserData = {
        ...
        email_marketing_news_opt_in: Boolean(marketingOptInEmail),
        email_marketing_offers_opt_in: Boolean(marketingOptInEmail),
        email_marketing_digest_opt_in: Boolean(marketingOptInEmail),
