...
const Schema: z.ZodType<Prisma.Enumftpquotatallies_history_quota_typeFilter> = z
  .object({
...
export const Enumftpquotatallies_history_quota_typeFilterObjectSchema = Schema;
