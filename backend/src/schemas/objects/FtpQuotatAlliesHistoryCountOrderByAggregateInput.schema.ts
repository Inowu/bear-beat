...
const Schema: z.ZodType<Prisma.FtpQuotatAlliesHistoryCountOrderByAggregateInput> =
  z
    .object({
...
export const FtpQuotatAlliesHistoryCountOrderByAggregateInputObjectSchema =
  Schema;
