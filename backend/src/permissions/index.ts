...
export const permissions = shield<Context>(
  {
    ...
    getOrdersFinancialSummary: isAdmin,
    ...
    'webhookInbox.listWebhookInboxEvents': isAdmin,
    'webhookInbox.getWebhookInboxEvent': isAdmin,
    listWebhookInboxEvents: isAdmin,
    getWebhookInboxEvent: isAdmin,
    ...
    getAnalyticsAdSpendMonthly: isAdmin,
    ...
    getAnalyticsCrmSegmentation: isAdmin,
    getAnalyticsCouponMetrics: isAdmin,
    getAnalyticsPaymentFailuresOps: isAdmin,
    ...
    getDownloadConsumptionDashboard: isAdmin,
    ...
    upsertAnalyticsAdSpendMonthly: isAdmin,
    deleteAnalyticsAdSpendMonthly: isAdmin,
    ...
    'webhookInbox.retryWebhookInboxEvent': isAdmin,
    retryWebhookInboxEvent: isAdmin,
